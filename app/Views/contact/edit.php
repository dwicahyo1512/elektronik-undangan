      ...
      <section class="section">
          ...
          <div class="section-body">
              ...
              <div class="row">
                  <div class="col-lg-8">
                      <div class="card">
                          <form action="<?= site_url('user/contacts/' . $contact->id_contact) ?>" method="post" autocomplete="off" novalidate="">
                                      ...
                                      <select name="id_grp" class="form-control select2 <?= isset($errors['id_grp']) ? 'is-invalid' : null ?> ">
                                          <?php
                                            foreach ($grp as $key => $value) : ?>
                                              <option value="<?= $value->id_grp; ?>" <?= old('id_grp', $contact->id_grp) == $value->id_grp ? 'selected' : null ?>><?= $value->nama_grp; ?></option>
                                          <?php endforeach;  ?>
                                      </select>
